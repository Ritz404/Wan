...
const AndroidNotification: React.FC = () => {
    ...
    useEffect(() => {
        ...
        if (userAgent.includes("Android") && !userAgent.includes("Shironime")) {
            ...
            {notificationVisible && (
                <div className="fixed top-16 right-4 w-72 bg-white text-black p-4 rounded shadow-md flex flex-col items-end" style={{ zIndex: 9999 }}>
                    ...
                    <div className="flex items-center mb-2">
                        ...
                        <span>Coba Shironime APK sekarang!</span>
                    </div>
                    <a href="https://Shironime.vercel.app/apk" className="bg-blue-500 text-white px-4 py-2 rounded">
                        Download
                    </a>
                </div>
            )}
